...
exports.getAllUser = (req, res) => {
    User.find().exec((err,user) => {
        ...
        // user.salt = undefined;               //for not showing salt to the user
        // user.encry_password = undefined;     //for not showing encry_password to the user
